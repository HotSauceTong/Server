...
namespace GameAPIServer.Utils;
public static class Security
{
    static readonly Int16 RepeatCnt = 4357;
    public static (byte[] salt, byte[] hashedPassword) GetSaltAndHashedPassword(String rawPassword)
    {
    ...
    public static String GenerateToken()
    {
        ...
        return Convert.ToBase64String(tokenBytes).Replace("/", "");
    }
}

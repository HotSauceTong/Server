...
-- (
--     item_code SMALLINT NOT NULL PRIMARY KEY COMMENT '해당 아이템의 코드',
...
--     max_stack BIGINT NOT NULL DEFAULT 1 COMMENT '한 공간당 최대 소유 개수'
-- );

-- CREATE TABLE IF NOT EXISTS mt_default_items_list
-- (
-- 	list_id SMALLINT NOT NULL PRIMARY KEY COMMENT '리스트의 코드',
-- 	item0_code SMALLINT NOT NULL DEFAULT -1 COMMENT '기본 지급 아이템1 종류',
-- 	item0_count BIGINT NOT NULL DEFAULT 0 COMMENT '기본 지급 아이템1 개수',
-- 	item1_code SMALLINT NOT NULL DEFAULT -1 COMMENT '기본 지급 아이템2 개수',
-- 	item1_count BIGINT NOT NULL DEFAULT 0 COMMENT '기본 지급 아이템2 종류',
-- 	item2_code SMALLINT NOT NULL DEFAULT -1 COMMENT '기본 지급 아이템3 개수',
-- 	item2_count BIGINT NOT NULL DEFAULT 0 COMMENT '기본 지급 아이템3 종류',
-- 	item3_code SMALLINT NOT NULL DEFAULT -1 COMMENT '기본 지급 아이템4 개수',
-- 	item3_count BIGINT NOT NULL DEFAULT 0 COMMENT '기본 지급 아이템4 종류'
-- );
...
-- 	item_code SMALLINT NOT NULL COMMENT '지급 아이템 코드',
-- 	item_count BIGINT NOT NULL COMMENT '지급 아이템 개수'
-- );

-- CREATE TABLE IF NOT EXISTS mt_package
-- (
-- 	package_code SMALLINT COMMENT '상품 코드, 중복 가능한 값',
-- 	item_code SMALLINT NOT NULL COMMENT '지급 아이템 코드',
-- 	item_count BIGINT NOT NULL COMMENT '지급 아이템 개수'
-- );
...
-- (
-- 	stage_code BIGINT PRIMARY KEY NOT NULL COMMENT '던전 아이디',
...
-- 	stage_code BIGINT NOT NULL COMMENT '던전 코드',
-- 	npc_code BIGINT NOT NULL COMMENT 'npc 코드',
-- 	npc_count BIGINT NOT NULL COMMENT 'npc 숫자',
-- 	exp_per_npc BIGINT NOT NULL COMMENT 'npc 하나가 주는 경험치'
-- );

-- CREATE TABLE IF NOT EXISTS mt_stage_items
-- (
-- 	pk_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT COMMENT 'pkid',  
-- 	stage_code BIGINT NOT NULL COMMENT '던전 아이디',
-- 	item_code BIGINT NOT NULL COMMENT '던전 제공 아이템'  
-- );